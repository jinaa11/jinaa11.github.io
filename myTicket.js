$(function() {
  ...
  $.getJSON('payment-info.json', function(data) {
            ...
            <div class="ticket-card">
              ...
              <div class="ticket-details">
                <div class="ticket-section destination-section">
                  ...
                  <img src="./image/payment/arrow.png" alt="오른쪽 화살표">
                  <div>
                ...
                <div class="ticket-section table-section">
                  ...
                  <div class="row">
                    <div class="col table-data">
                      <img src="../image/payment/refresh.png" alt="새로고침">
                ...
                <div class="ticket-footer">
                  ...
                  <div class="d-flex justify-content-around">
                    <div class="text-center">
                      <img src="../image/payment/alert.png" alt="철도범죄신고">
                      <p>철도범죄신고</p>
                    </div>
                    <div class="text-center">
                      <img src="../image/payment/handicap.png" alt="승하차 도우미 신청">
                      <p>승하차 도우미 신청</p>
                    </div>
                    <div class="text-center">
                      <img src="../image/payment/sms.png" alt="보호자 안심 SMS">
                      <p>보호자 안심 SMS</p>
                    </div>
                    <div class="text-center">
                      <img src="../image/payment/share.png" alt="일정공유">
                      <p>일정공유</p>
                    </div>
                  </div>
                </div>
